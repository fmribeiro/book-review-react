...
export const fetchFavoritesReviews = () => {
  return async (dispatch, getState) => {
    console.log("fetchFavoritesReviews");
    try {
      const response = await fetch(
        `https://whispering-springs-63743.herokuapp.com/book-review/reviews/favorites/page/0/size/10`
      );
      if (!response.ok) {
